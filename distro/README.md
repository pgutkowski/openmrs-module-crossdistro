...
This repository contains the crossdistro OpenMRS Open Web App.
...
This will create a file called `crossdistro.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/home/user/openmrs/openmrs-platform`
...
{
  "LOCAL_OWA_FOLDER": "/home/user/openmrs/openmrs-platform",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/crossdistro/index.html"
}
```
